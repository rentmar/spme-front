<template>
  <v-container>
    ...
    <v-card v-if="emptyResponse && !loadingRendiciones" class="mb-4">
    ...
    <DialogValidarRendicion
      v-model="dialogValidarRendicion"
...
const dialogValidarRendicion = ref(false)
...
function handleAccion({ tipo, actividadId, tareaId, formulario }) {
  if (tipo === 'crear') {
    ...
    dialogValidarRendicion.value = true
  }
}
