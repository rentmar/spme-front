  ...
  async function submitForm() {
    ...
    formData.value.correo_administrador = correoAdministradorActual
      ...
      const cuerpoMensaje = {
        ...
        contenido: 'Rendicion de Cuentas PEI pediente del formulario ' + numeroFormulario.value + '. URL: ' + urlForm,
        tipo: 'sistema',
        prioridad: 3,
      }
      ...
      const cuerpoMensaje2 = {
        ...
        asunto: 'Rendicion de Cuentas PEI',
        contenido: 'Rendicion de Cuentas PEIpediente del formulario ' + numeroFormulario.value + '. URL: ' + urlForm,
        tipo: 'sistema',
        prioridad: 3,
      }
      ...
      try {
        const emailPayload = {
          ...
          datos_solicitud: {
            ...
            prioridad: 'alta',
            descripcion: formData.value.descripcion_actividad || 'Rendicion de Cuentas PEI para actividad',
