    ...
    <div v-if="!cargandoGeneral">
      ...
      <v-row>
        ...
        <v-col cols="12" md="4" lg="3">
          ...
          <!--Controles-->
          <RevisorSolicitudPagoDirecto></RevisorSolicitudPagoDirecto>
          <RedactorSolicitudPagoDirecto></RedactorSolicitudPagoDirecto>
...
const generarPdfSolicitudFondosFunc = async () => {
  ...
  try {
    ...
    await generarPdfSolicitudPagoDirecto(idSolicitud)
  } catch (error) {
...
const generarPdfSolicitudSubactividadFunc = async () => {
  ...
  try {
    await generarPdfSolicitudPagoDirectoTareas(idSolicitud)
  } catch (error) {
...
onMounted(async () => {
  ...
  await storeSolPagoDirecto.cargarSolicitud(idSolicitud)
})
</script>
