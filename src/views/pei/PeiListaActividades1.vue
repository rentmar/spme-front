  ...
  return actividades.value.filter(
    (act) =>
      (searchQuery.value === null ||
        ...
        (act.descripcion && act.descripcion.toLowerCase().includes(searchQuery.value.toLowerCase()))) &&
...
const formatCurrency = (value) => {
  // ✅ CORRECCIÓN: Se asegura de que el valor sea un número antes de llamar a toFixed.
