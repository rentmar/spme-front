        ...
        <v-col cols="12" md="3">
            <v-card class="pa-4" v-if="selectedActividad">
                ...
                <v-card-text class="pa-0 pt-2">
                    ...
                    <p><strong>Fecha Programada:</strong> {{ formatFecha(selectedActividad.fecha_programada) }}</p>
        ...
        <v-col cols="12" md="9">
            <svg id="fondo" :viewBox="viewBox">
                ...
                <g v-for="(actividad, fila) in actividadesPaginadas" :key="actividad.codigo + '-' + fila">
                    ...
                    <title>{{ actividad.nombre_corto }} ({{ formatFecha(actividad.fecha_inicio) }} - {{ formatFecha(actividad.fecha_cierre) }})</title>
                </g>
