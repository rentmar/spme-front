<template>
  <div>
    <v-alert
      ...
      border="start"
    >
      Seleccione los revisores para el documento
    </v-alert>
    <v-card variant="outlined" class="mb-4">
      <v-card-text class="pa-4">
        ...
        <!-- Responsable Direccion Administrativo -->
        <div class="mb-4">
          <div class="d-flex align-center mb-2">
            <v-icon color="primary" class="mr-2">mdi-account-tie</v-icon>
            <span class="text-subtitle-1 font-weight-medium"
              >Responsable Direccion Administrativa</span
            >
          </div>
          <v-autocomplete
    ...
    <v-card
      v-if="coordinacionSelected || administrativoSelected || contableSelected"
      variant="tonal"
