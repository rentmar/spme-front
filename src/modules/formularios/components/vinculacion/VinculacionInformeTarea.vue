...
// Store y utilidades
const solStore = useSolicitudesStore()
...
const solicitudesViaje = computed(() => solStore.solicitudesViajeDisponiblesTarea || [])
...
const getVinculacion = () => {
  ...
  return {
    ...
    tarea_id: props.idTarea,
    informe_tarea_id: props.idInformeTarea,
