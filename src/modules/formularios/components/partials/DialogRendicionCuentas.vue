                          ...
                          >
                            <div class="d-flex justify-space-between">
                              <div>
                                ...
                                <div class="text-grey">
                                  {{ formatDate(item.fecha) }} | Partida: {{ item.partida }}
...
const { listaRendicionCuentasActividad, obtenerListaRendicionCuentasPorIdActividad } =
  useRendicionCuentas()
...
const rendiciones = computed(() => {
  if (listaRendicionCuentasActividad.value && listaRendicionCuentasActividad.value.rendiciones) {
    return listaRendicionCuentasActividad.value.rendiciones
  }
  return []
})
...
const cargarDatos = async () => {
  ...
  try {
    await obtenerListaRendicionCuentasPorIdActividad(props.actividadId)

    // Extraer estadísticas y actividad de la respuesta
    if (listaRendicionCuentasActividad.value) {
      estadisticas.value = listaRendicionCuentasActividad.value.estadisticas
      actividad.value = listaRendicionCuentasActividad.value.actividad
    }

    console.log('Datos cargados (rendición):', listaRendicionCuentasActividad.value)
