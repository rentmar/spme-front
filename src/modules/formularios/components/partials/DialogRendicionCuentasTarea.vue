          ...
          <div class="d-flex justify-space-between align-center mb-3">
            ...
            <div class="text-right">
              <div v-if="estadisticas" class="text-caption">
                {{ estadisticas.total_rendiciones }} rendiciones
              </div>
...
const rendiciones = computed(() => {
  if (listaRendicionCuentasTarea.value && listaRendicionCuentasTarea.value.rendiciones) {
    return listaRendicionCuentasTarea.value.rendiciones
  }
  return []
})
...
const cargarDatos = async () => {
  ...
  try {
    ...
    if (listaRendicionCuentasTarea.value) {
      estadisticas.value = listaRendicionCuentasTarea.value.estadisticas
      actividad.value = listaRendicionCuentasTarea.value.actividad
      tarea.value = listaRendicionCuentasTarea.value.tarea
    }

    console.log('Datos cargados (rendición tarea):', listaRendicionCuentasTarea.value)
