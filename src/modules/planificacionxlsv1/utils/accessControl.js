...
const reglasTarea = {
  ...
  coordinador: {
    permitidas: ['codigo', 'titulo', 'descripcion', 'estado', 'fecha_limite', 'fecha_creacion'],
    bloqueadas: ['presupuesto', 'presupuestoDesglose'],
  },
  contable: {
    permitidas: ['codigo', 'presupuesto', 'presupuestoDesglose'],
    bloqueadas: ['titulo', 'descripcion', 'estado', 'fecha_creacion', 'fecha_limite'],
  },
  tecnico: {
