<template>
  <div class="pa-4">
    ...
    <MisSolicitudesTabla
      ...
      empty-subtitle="Crea una nueva solicitud de fondos para empezar"
...
const headersBase = [{ title: 'N° Formulario', key: 'numeroForm', sortable: true, width: '200' }]
...
const headersFinal = [
  ...
  { title: 'Fecha', key: 'fechaSolicitud', sortable: true, width: '110' },
