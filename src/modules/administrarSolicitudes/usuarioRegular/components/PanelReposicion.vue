<template>
  <div class="pa-4">
    ...
    <MisSolicitudesTabla
      ...
      :page="page"
      no-data-text="No tienes solicitudes de reposición"
      empty-icon="mdi-cash-refund"
      empty-title="No tienes solicitudes de reposición"
      empty-subtitle="Crea una nueva solicitud de reposición para empezar"
    ...
    >
      ...
      <!-- DESCRIPCIÓN (columna específica de reposición) -->
      <!-- eslint-disable-next-line vue/valid-v-slot -->
