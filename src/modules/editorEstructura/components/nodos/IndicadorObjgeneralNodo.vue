  ...
  <BaseNodo :id="id" :data="data" :show-delete="true" :show-menu="true" v-bind="$attrs">
    ...
    <template #default>
      <div class="text-body-2">
        ...
        <div class="mb1"><strong>Descripcion:</strong> {{ data.nodoProyecto.descripcion }}</div>
        <div class="mb1"><strong>Definicion:</strong> {{ data.nodoProyecto.definicion }}</div>
        ...
        <div class="mb-1">
          <strong>Fecha Target poblacion:</strong> {{ data.nodoProyecto.fechaTargetPoblacion }}
        </div>
        ...
        <div class="mb-1">
          <strong>Fecha target q3:</strong> {{ data.nodoProyecto.fechaTargetQ1 }}
        </div>
      </div>
    </template>
