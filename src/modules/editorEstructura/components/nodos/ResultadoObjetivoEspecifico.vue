    ...
    const payload = {
      ...
      meta: {
        ...
        nodoProyecto: {
          ...
          fechaTargetPoblacion: indicadorResultadoObjEspecifico.value.fechaTargetPoblacion,
          tipo: indicadorResultadoObjEspecifico.value.tipo,
          frecuencia: indicadorResultadoObjEspecifico.value.frecuencia,
          responsable: indicadorResultadoObjEspecifico.value.responsable,
          baseline: indicadorResultadoObjEspecifico.value.baseline,
          fechaLineaBase: indicadorResultadoObjEspecifico.value.fechaLineaBase,
          target_q1: indicadorResultadoObjEspecifico.value.target_q1,
          fechaTargetQ1: indicadorResultadoObjEspecifico.value.fechaTargetQ1,
          target_q2: indicadorResultadoObjEspecifico.value.target_q2,
          fechaTargetQ2: indicadorResultadoObjEspecifico.value.fechaTargetQ2,
          target_q3: indicadorResultadoObjEspecifico.value.target_q3,
          fechaTargetQ3: indicadorResultadoObjEspecifico.value.fechaTargetQ3,
