<template>
  <div class="indicadores-roe-container">
    <!-- Cabecera retráctil -->
      ...
      <v-card-text class="pa-0">
        ...
        >
          ...
          <span class="text-subtitle-1 font-weight-bold mr-2">
            Indicadores de Resultado de Objetivo Específico
          </span>

          <v-chip color="purple" size="small" class="mr-2"> Total: {{ totalSolicitados }} </v-chip>
          ...
          <v-row>
            ...
            <v-col cols="12" md="4">
              <v-card elevation="2" class="h-100">
                <v-card-title class="bg-purple text-white py-2">
                  <v-icon class="mr-2">mdi-information</v-icon>
                  Ind. ROE: {{ indicador.codigo }}
                  <v-spacer></v-spacer>
                  <v-chip color="white" text-color="purple" size="x-small">
                    ID: {{ indicador.id }}
                  </v-chip>
                </v-card-title>
                ...
                <v-card-text class="pa-2">
                  ...
                  <v-row dense>
                    ...
                    <v-col cols="6">
                      ...
                      <!-- Resultado de Objetivo Específico ID -->
                      <div class="mb-2">
                        <div class="text-caption font-weight-bold text-grey">Resultado de OE</div>
                        <div class="text-body-2">
                          ID: {{ indicador.resultado_obj_especifico_id || 'No asignado' }}
                        </div>
                      </div>
...
const submitRegistro = async (indicador) => {
  ...
  const registroData = {
    ...
    tipo_indicador: 'indicadorroe', // ✅ ESTÁ BIEN
  ...
  try {
    ...
    console.log('Registro ROE guardado:', registroData)
    ...
    console.error('Error guardando registro ROE:', error)
  } finally {
...
const eliminarRegistro = async (registroId, indicadorId) => {
  ...
  try {
    ...
    console.log('Registro ROE eliminado:', registroId)
    ...
    console.error('Error eliminando registro ROE:', error)
  }
}
