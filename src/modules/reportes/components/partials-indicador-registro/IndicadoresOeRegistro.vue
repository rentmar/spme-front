    ...
    <v-card class="mb-4" elevation="2">
      <v-card-text class="pa-0">
        ...
        >
          ...
          <v-chip color="green" size="small" class="mr-2"> Total: {{ totalSolicitados }} </v-chip>
          ...
          <v-row>
            ...
            <v-col cols="12" md="4">
              <v-card elevation="2" class="h-100">
                <v-card-title class="bg-green text-white py-2">
                  <v-icon class="mr-2">mdi-information</v-icon>
                  Ind. OE: {{ indicador.codigo }}
                  <v-spacer></v-spacer>
                  <v-chip color="white" text-color="green" size="x-small">
                    ID: {{ indicador.id }}
                  </v-chip>
                </v-card-title>
                ...
                <v-card-text class="pa-2">
                  ...
                  <v-row dense>
                    ...
                    <v-col cols="6">
                      ...
                      <!-- Objetivo Específico ID -->
                      <div class="mb-2">
                        <div class="text-caption font-weight-bold text-grey">
                          Objetivo Específico
                        </div>
                        <div class="text-body-2">
                          ID: {{ indicador.objetivo_especifico_id || 'No asignado' }}
                        </div>
                      </div>
                    </v-col>
...
const submitRegistro = async (indicador) => {
  ...
  try {
    ...
    console.error('Error guardando registro OE:', error)
  } finally {
...
const eliminarRegistro = async (registroId, indicadorId) => {
  ...
  try {
    ...
    console.log('Registro OE eliminado:', registroId)
    ...
    console.error('Error eliminando registro OE:', error)
  }
}
