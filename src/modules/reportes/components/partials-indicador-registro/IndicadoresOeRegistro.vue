          ...
          <v-row>
            ...
            <v-col cols="12" md="4">
              <v-card elevation="2" class="h-100">
                ...
                <v-divider></v-divider>
                <v-card-text class="pa-2">
                  <!--Mensaje de registros existentes-->
                  <div
            ...
            <!--COLUMNA 3: Bitacora-->
            <v-col cols="12" md="4">
              <TimelineBitacora></TimelineBitacora>
            </v-col>
          </v-row>
        </div>
      </div>
...
/******************************** CRUD ***********************************************/
const editarRegistro = async (registro, indicador) => {
  if (!registro) return
...
const submitRegistro = async (indicador) => {
  ...
  console.log('Dato registroExistente Data', registroExistenteData)
